...
import org.apache.flink.connector.redis.util.Common;
import org.apache.flink.connector.redis.schema.RedisSerde;
				...
				if (kind == RowKind.INSERT || kind == RowKind.UPDATE_AFTER) {
					switch (redisConfig.getMode()) {
						case HASH:
							...
							if (!Constants.REDIS_OPERATE_CODE_OK.equals(ret)) {
								continue;
							}
